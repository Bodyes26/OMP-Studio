...
### Fixed
- Ripristinate le animazioni di caricamento e aggiornamento nel pannello delle quote di utilizzo: corretta l'animazione dello spinner centrale durante il primo caricamento, ripristinata la barra pulsante di caricamento e la rotazione dell'icona di refresh durante il recupero dei dati, e reintrodotte le animazioni di ingresso fluido delle sezioni provider e di riempimento progressivo delle barre di consumo.
- Autoscroll e ancoraggio in fondo nella chat GUI: risolto il problema per cui l'arrivo di nuovi messaggi, streaming o chiamate tool causava la perdita dell'ancoraggio e la comparsa spuria del pulsante «↓ In fondo». Lo scroll resta ora saldamente ancorato in fondo durante tutto lo streaming e l'espansione dei contenuti; se l'utente scorre intenzionalmente verso l'alto la posizione si ferma dove è stata portata, e quando si scorre nuovamente vicino al fondo o si preme il pulsante l'autoscroll si riaggancia automaticamente.
